...
```bash
python -m pytest tests/    # 92 теста
```
...
- **Этап 3 «Панель»** — частично: «чтение с флагами» реализовано локальной
  страницей `review.html` (без сервера); полный React-интерфейс — по желанию,
  в `src/` лежит заготовка Next.js.
