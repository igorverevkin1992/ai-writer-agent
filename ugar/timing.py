...
История переходов в status.yaml хранит таймстемпы; правило разделения — по задаче:

* интервал между двумя переходами, записанными ВНУТРИ ОДНОЙ задачи (`ugar run`, кнопка панели,
