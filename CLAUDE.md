...
- `ugar/circles.py` — круги истории = несущий каркас драматургии (Р-020): том → четыре акта
  ...
  Круг главы (Р-024): шаги 1–7 обязательны, шаг 8 «Изменение» — по материалу (`step_unset`/`chapter_steps_present`:
  незаданный шаг 8 не идёт в окно/Э2, `КРУГ-1` его не считает). Материал аналитика тома/актов (Р-026): тема
  цикла (13 §1, `cycle_theme`), арки 2.5 целиком, события с участниками сцен — Писателю не выводится.
- Арки тома 2.5 (Р-025): `22_Арки_Том{N}.md` → `realcanon.parse_arcs` → `exports/arcs.json` (`schemas.Arc`;
  без документа — пусто). Писателю — только «что видно снаружи» (`compiler.arc_lines`, фильтр Р-022, без ссылок
  на тома); линтер `АРКА-1/2` в `lint_canon.check_arcs`.
