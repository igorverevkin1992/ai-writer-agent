...
from ugar import circles, compiler, exporter, guard, lint, realcanon, verifier2
...
def test_шаблон_аналитика_кругов_про_шаг_8():
    text = (REPO / "ugar" / "templates" / "круг_истории_система.md").read_text(encoding="utf-8")
...
def test_экспорт_арок_демо_без_документа(ws, library):
    ...
    # старые exports/ без arcs.json — тоже пусто, не ошибка
