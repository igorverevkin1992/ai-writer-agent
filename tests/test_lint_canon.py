"""Линтер канона, второй машинный слой (`ugar/lint_canon.py`): дозы и документы, время,
...
from ugar import exporter, guard, lint, realcanon
...
def test_вопросы_к_решениям_автора(real):
    """КАНОН-1 — заметки по нетронутому канону (аудит 7.1, 7.3, 7.7, 7.11)."""
    report = _run(real)
