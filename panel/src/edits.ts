...
// ugar/review.py::parse_edits_text (маркеры в начале строки, значение до пустой строки).
...
/** Строка edits.md для пары «было → стало». Многострочная цитата допустима, но без пустых строк
...
/** Добавляет пару в конец текста edits.md, отделяя пустой строкой. */
